 ...
 */
public final class CharTemplateData implements DocumentParser
{
	private static final Logger LOGGER = LoggerFactory.getLogger(CharTemplateData.class.getName());
