...
public class HeroeList
{
	...
	{
		_heroeList.append("<table border=0 cellspacing=0 cellpadding=2 width=480>");
		_heroeList.append("<tr>");
		_heroeList.append("<td align=center FIXWIDTH=130>" + name + "</td>");
		_heroeList.append("<td align=center FIXWIDTH=160>" + className(ChrClass) + "</td>");
		_heroeList.append("<td align=center FIXWIDTH=80>" + played + "</td>");
		_heroeList.append("<td align=center FIXWIDTH=70>" + ((isOnline) ? "<font color=99FF00>Online</font>" : "<font color=CC0000>Offline</font>") + "</td>");
		_heroeList.append("</tr>");
		_heroeList.append("</table>");
		_heroeList.append("<img src=\"L2UI.Squaregray\" width=\"480\" height=\"1\">");
	}
