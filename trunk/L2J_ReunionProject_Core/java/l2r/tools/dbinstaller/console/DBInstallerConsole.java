 ...
 */
package l2r.tools.dbinstaller.console;

import java.sql.Connection;
import java.util.Scanner;
import java.util.prefs.Preferences;

import l2r.tools.dbinstaller.DBOutputInterface;
import l2r.tools.dbinstaller.RunTasks;
import l2r.tools.dbinstaller.util.mysql.MySqlConnect;
import l2r.util.CloseShieldedInputStream;
