...
public class GUserInterface extends BaseGameServerRegister implements ActionListener
{
	...
	public void actionPerformed(ActionEvent e)
	{
		...
		{
			JOptionPane.showMessageDialog(getFrame(), getBundle().getString("credits") + Config.EOL + "http://www.l2reunion.com" + Config.EOL + Config.EOL + getBundle().getString("icons") + Config.EOL + Config.EOL + getBundle().getString("langText") + Config.EOL + getBundle().getString("translation"), getBundle().getString("aboutItem"), JOptionPane.INFORMATION_MESSAGE, ImagesTable.getImage("l2reunionlogo.png"));
		}
