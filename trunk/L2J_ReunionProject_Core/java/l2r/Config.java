...
public final class Config
{
	...
	public static void load()
	{
		if (Server.serverMode == Server.MODE_GAMESERVER)
		{
			...
			ENABLE_COMMUNITY = Boolean.parseBoolean(General.getProperty("EnableCommunity", "True"));
		...
		else if (Server.serverMode == Server.MODE_LOGINSERVER)
		{
			...
			EMAIL_SERVERINFO_ADDRESS = emailSettings.getProperty("ServerInfoAddress", "info@myl2reunion.com");
			...
			EMAIL_SYS_ADDRESS = emailSettings.getProperty("EmailSystemAddress", "noreply@myl2reunion.com");
