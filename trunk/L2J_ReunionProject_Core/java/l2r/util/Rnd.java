...
public final class Rnd
{
	...
	public static enum RandomType
	{
		...
		/**
		 * Like {@link l2r.util.Rnd.RandomType#UNSECURE_ATOMIC}.<br>
		 * Each thread has it`s own random instance.<br>
		 * Provides best parallel access speed.
		 * @see l2r.util.Rnd.ThreadLocalRandom
		 */
		 ...
		 * @see l2r.util.Rnd.NonAtomicRandom
		 */
		UNSECURE_VOLATILE
	}
